...
<nav class="breadcrumbs text-center text-uppercase">
    <ul class="list-unstyled">
        ...
        <li>/</li>
        <li>@lang('messages.services_title')</li>
    </ul>
</nav>
...
<div class="wrapper">
    <div class="top">
        <div class="container">
            <div class="title">
                <h1 style="text-align: center">@lang('messages.services_title')</h1>
            </div>
        </div>
    </div>
                ...
                <div class="col-xs-12">
                    ...
                    <div class="blog-slider">
                        <div class="col-xs-12 col-sm-4">
                            <div class="service-holder">
                                <div class="img-holder">
                                    <img src="assets/images/portfolio/jan.jpg"
                        ...
                        <div class="col-xs-12 col-sm-4">
                            <div class="service-holder">
                                <div class="img-holder">
                                    <img src="assets/images/portfolio/DSC_4010.JPG"
                                        style="width: 365px; height: 200px; object-fit: cover" class="img-fluid">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xs-12 col-sm-4">
                            <div class="service-holder">
                                <div class="img-holder">
                                    <img src="assets/images/portfolio/DSC_4151.JPG"
                                        style="width: 365px; height: 200px; object-fit: cover" class="img-fluid">
                                </div>
                            </div>
                        </div>
